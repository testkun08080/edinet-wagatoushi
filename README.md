...
- `docs`: 全体ドキュメント（索引は [docs/README.md](docs/README.md)。技術詳細は [docs/DATA_PIPELINE_AND_CALCULATIONS.md](docs/DATA_PIPELINE_AND_CALCULATIONS.md)、列・DB 差分は [docs/METRICS_UI_AND_DB_GAP.md](docs/METRICS_UI_AND_DB_GAP.md)）
