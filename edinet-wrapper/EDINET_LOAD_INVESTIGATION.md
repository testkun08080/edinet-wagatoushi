...
- **ファイル**: `edinet-wrapper/scripts/prepare_edinet_corpus.py`
- **処理**:
...
| コーパス取得エントリ | `edinet-wrapper/scripts/edinet_corpus.sh` |
| 書類一覧・DL ロジック | `edinet-wrapper/scripts/prepare_edinet_corpus.py` |
